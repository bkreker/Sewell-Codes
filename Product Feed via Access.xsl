					...
					<tbody id="CTRL2">
						<xsl:for-each select="item">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="online_only"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="shipping_weight"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="cable_style"/>
								</td>
								<td>
