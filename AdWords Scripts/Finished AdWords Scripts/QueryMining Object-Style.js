...
function main() {
  ...
  while (keywordRows.hasNext()) {
    ...
    if (NEGS_BY_GROUP[keywordRow["AdGroupId"]] == undefined) {
      var selKeyword = {
        Id:keywordRow[keywordParam].toLowerCase(), 
        MatchType:keywordRow["KeywordMatchType"].toLowerCase()
      };
      NEGS_BY_GROUP[keywordRow["AdGroupId"]] = selKeyword;
      //print('line 66 selKeyword: ' + selKeyword.Id + " "+ selKeyword.MatchType);
    ...
    print('Object.keys(NEGS_BY_GROUP): ' + Object.keys(NEGS_BY_GROUP));
 ...
 // print("Line 190 ACTIVE_CAMP_IDS: " + ACTIVE_CAMP_IDS.join(","));
