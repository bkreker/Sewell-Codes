...
// Source: https://raw.githubusercontent.com/OutshineLabs/typed-adwords/master/index.d.ts
...
interface StringAccessor{
    ...
    interface ReportRow extends StringAccessor {
    ...
    interface SimplePlacement extends AdWordsEntity {
      getAdGroup(): AdGroup;
      getCampaign(): Campaign;
      getId(): number;
      getUrl(): string;
