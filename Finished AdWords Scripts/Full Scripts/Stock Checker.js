...
var pausedUrls = [['Ads Paused: '],['\nCampaign','AdGroup','Ad','URL']]; 
var pausedAdGroups = [['Ad Groups Paused: '],['\nCampaign','AdGroup']]; 

// Array to hold all  enabled urls
var enabledUrls = [['Ads Enabled: '],['\nCampaign','AdGroup','Ad','URL']]; 
var enabledAdGroups = [['Ad Groups Enabled: '],['\nCampaign','AdGroup']]; 
...
function enableURLs(){  
  ...
  while(iter.hasNext()) {	    
    ...
    // get the Urls
    if(entity.urls().getFinalUrl()) {urls.push(entity.urls().getFinalUrl());}    
    if(entity.urls().getMobileFinalUrl()) {urls.push(entity.urls().getMobileFinalUrl());}
