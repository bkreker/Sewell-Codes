...
var EMAIL_LIST; 
var CUSTOMIZER_LIST = [['SKU (text)','Promotion (text)','Price (price)','RoundedPrice (price)','Target campaign','Target ad group','Target keyword']];
...
function main() {   
  ...
  var day = date.day;
  var time = date.time;
  EMAIL_LIST = [['SKU','Promotion','Price','RoundedPrice','Campaign','AdGroup','Url','Last Updated: ', day, time]];
  getPrices();
  updateReport();
  EmailResults();
}
