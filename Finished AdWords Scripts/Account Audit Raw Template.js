...
function main() {
  //1. Campaigns
  //  a. Target the right locations. Commented out by Josh because i don't need this right now
  ...
  var MAX_NUM_OF_ADS = 4;
  verifyAdGroupNumberOfAds(NUMBER_OF_ADS, MAX_NUM_OF_ADS);
   newLine();
  //3. Keywords
...
function verifyAdGroupNumberOfAds(requiredNumberOfAds, maxNumAds) {
...
function EmailResults() {
	...
	'AdWords Alert: Account Audit', EMAIL_MESSAGE.toString());
}
